...
<style id="page/appmsg/page_mp_article_improve_combo.css">
    ...
    .audio_area.unsupport .unsupport_tips {
        display: block
    }
    
    .audio_area.unsupport .pic_audio_default {
        display: inline-block
    }
    
    .audio_area.unsupport .icon_audio_playing {
        display: none
    }
    
    .audio_area.unsupport .icon_audio_default {
        display: none
    }
    ...
    .audio_play_area .icon_audio_default {
        background: transparent url(//res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon/appmsg/audio/icon_audio_unread26f1f1.png) no-repeat 0 0;
        width: 18px;
        height: 25px;
        vertical-align: middle;
        display: inline-block;
    ...
    .audio_play_area .icon_audio_playing {
        background: transparent url(//res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon/appmsg/audio/icon_audio_reading_126f1f1.png) no-repeat 0 0;
        width: 18px;
        height: 25px;
        vertical-align: middle;
        display: inline-block;
    ...
    @-webkit-keyframes audio_playing {
        30% {
            background-image: url(//res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon/appmsg/audio/icon_audio_reading_126f1f1.png)
        }
        31% {
            background-image: url(//res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon/appmsg/audio/icon_audio_reading_226f1f1.png)
        }
        61% {
            background-image: url(//res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon/appmsg/audio/icon_audio_reading_226f1f1.png)
        }
        62% {
            background-image: url(//res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon/appmsg/audio/icon_audio_reading_326f1f1.png)
        }
        100% {
            background-image: url(//res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon/appmsg/audio/icon_audio_reading_326f1f1.png)
        }
    ...
    .share_mod_context:first-child {
        margin-top: 0
    }
    
    .share_mod_context .share_mod_hd {
        position: relative;
        color: #b2b2b2;
        line-height: 2.8;
        font-size: 15px
    ...
    .share_mod_context .share_mod_hd:before {
        content: " ";
        position: absolute;
        left: 0;
        bottom: 0;
    ...
    .share_mod_context .account_info .flex_bd {
        padding-left: .85em
    }
    
    .share_mod_context .account_avatar {
        width: 33px;
        height: 33px;
        padding: 0
    }
    
    .share_mod_context .account_nickname {
        overflow: hidden;
        text-overflow: ellipsis;
        display: -webkit-box;
        -webkit-box-orient: vertical;
    ...
    .share_mod_context .account_nickname_inner {
        font-weight: 400;
        vertical-align: top
    }
    
    .share_mod_context .account_desc {
        overflow: hidden;
        text-overflow: ellipsis;
        display: -webkit-box;
        -webkit-box-orient: vertical;
    ...
    .share_mod_context .account_desc_inner {
        display: inline;
        vertical-align: top
    }
    
    .share_mod_context .share_notice {
        margin-bottom: 18px
    }
    
    .share_mod_context .share_media {
        padding-bottom: 18px
    }
    
    .share_mod_context .more_media_title {
        font-weight: 400
    }
    
    .share_mod_context .more_media_mask {
        position: absolute;
        bottom: 0;
        left: 0;
        right: 0;
        top: 0;
        background-image: -moz-linear-gradient(top, rgba(255, 255, 255, 0) 0, rgba(255, 255, 255, 0) 30%, rgba(0, 0, 0, 0.5) 100%);
        background-image: -o-linear-gradient(top, rgba(255, 255, 255, 0) 0, rgba(255, 255, 255, 0) 30%, rgba(0, 0, 0, 0.5) 100%);
        background-color: rgba(46, 46, 46, 0.3);
        background-image: -webkit-gradient(linear, 0 0, 0 100%, from(rgba(255, 255, 255, 0)), color-stop(30%, rgba(255, 255, 255, 0)), to(rgba(0, 0, 0, 0.5)));
        background-image: -webkit-linear-gradient(top, rgba(255, 255, 255, 0) 0, rgba(255, 255, 255, 0) 30%, rgba(0, 0, 0, 0.5) 100%);
        background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0) 0, rgba(255, 255, 255, 0) 30%, rgba(0, 0, 0, 0.5) 100%);
        background-color: transparent
    }
    ...
    .page_share_audio .more_media {
        position: relative;
        padding: .8em 0
    }
    
    .page_share_audio .more_media:before {
        content: " ";
        position: absolute;
        left: 0;
        bottom: 0;
    ...
    .page_share_audio .more_media_title {
        display: block;
        width: auto;
        overflow: hidden;
        text-overflow: ellipsis;
    ...
    .page_share_audio .more_media_desc {
        font-size: 14px;
        color: #b2b2b2
    }
    
    .page_share_audio .share_audio_title {
        margin: .5em 0 1.2em
    }
    
    .page_share_audio .share_audio_switch {
        margin-top: -8px
    }
